...
The [typing reference](typing-reference.md) describes the keys, half forms, punctuation, and alternatives. The [live demo](https://ojastechnologies.github.io/sahajlipi/demo/) uses this same core and adapter. This API is experimental; avoid treating the starter lexicon or current candidate order as a stable linguistic database.
